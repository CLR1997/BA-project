...
df_scores_sm.std.r2
```
no time / Semester > Time > Semester. Semester Pretty bad
...
```
This is problematic, they aren't really nested.
...
Perhaps the students vary too much among themselves too much. Taking a look when the student data is averaged over all 4 Semester
