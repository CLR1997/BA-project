...
#summary(full.model.lmer.reduced.interactions)

fmlri.cov.matrix <- vcovHC(full.model.lmer.reduced.interactions)
coeftest(full.model.lmer.reduced.interactions, vcov = fmlri.cov.matrix)
